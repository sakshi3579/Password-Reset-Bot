...
def handle_submission(ack, client, body, view, logger):
    ...
    try:
        # Save to DB
        msg = f"your submission is successful to reset your password "
        ...
        if (len(password) >= 16):
            for i in password:
                ...
                if (i == '@' or i == '$' or i == '_' or i == '.' or i == ','):
                    p += 1
        if ((l >= 1 and u >= 1 and p >= 1 and l + p + u == len(password)) or (l >= 1 and u >= 1 and d >= 1 and l + d + u == len(password)) or (l >= 1 and p >= 1 and d >= 1 and l + d + p == len(password)) or (u >= 1 and p >= 1 and d >= 1 and u + d + p == len(password))):
            ...
            client.chat_postMessage(channel=user, text="Please Type Valid Password.your password must include any of three categories i.e lowercase, numbers, special character and Uppercase. your password *must not include your username* and it must be more than 7 characters")
    except Exception as e:
        # Handle error
